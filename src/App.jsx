...
const DEFAULT_TIMELINE = [
  { id: 't-1', start: 0.0, end: 1.8, text: 'So sánh hai khái niệm:', pose: 'default', highlight: 'none' },
  { id: 't-2', start: 1.8, end: 4.5, text: 'Đây là khách quan.', pose: 'point_left', highlight: 'left' },
  { id: 't-3', start: 4.5, end: 7.0, text: 'Đây là chủ quan.', pose: 'point_right', highlight: 'right' },
...
export default function App() {
  ...
  const triggerCanvasRedraw = () => {
    ...
    const isUnstartedInitialState = !isPlaying && currentTime === 0;

    const activeBlock = isUnstartedInitialState
      ? null
      : timelineBlocks.find(
    ...
    const frameState = {
      ...
      timelineBlocks,
      comparisons,
      subtitleText: isUnstartedInitialState ? '' : (activeBlock ? activeBlock.text : ''),
      mascotPose: isUnstartedInitialState ? 'default' : (activeBlock ? activeBlock.pose : 'default'),
      highlight: isUnstartedInitialState ? 'none' : (activeBlock ? activeBlock.highlight : 'none'),
